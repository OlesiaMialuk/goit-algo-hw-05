...
text_article_1 = read_file("C:\\Users\\o\\Desktop\\стаття 1.txt") # шлях до файлу
text_article_2 = read_file("C:\\Users\\o\\Desktop\\стаття 2.txt") # шлях до файлу

real_pattern = "дерева"
fake_pattern = "підрядок"
